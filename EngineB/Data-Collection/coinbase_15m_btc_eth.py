#!/usr/bin/env python3
"""
Download 15m OHLCV for BTC-USD and ETH-USD from Coinbase Exchange.
Saves CSVs to data/coinbase_15m and writes metadata.json with start dates.
"""
...
GRAN_S = 900  # 15m
USER_AGENT = "btc-eth-15m-downloader/1.0"
...
def main():
    ...
    for product in ASSETS:
        out_csv = out_dir / f"{product}_15m.csv"
