...
def main() -> None:
    ...
    parser.add_argument("--input", default="EngineB/Data/BTC-USD_15m.csv")
    parser.add_argument("--out", default="EngineB/Outputs/QA/qa_report_15m.txt")
    args = parser.parse_args()

    df = _load_csv(Path(args.input))
    report = _qa_report(df, freq="15min")
